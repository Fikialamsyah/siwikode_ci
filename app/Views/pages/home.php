    ...
    <div class="container">
        <div class="row">
            <div class="col align-self-center">
                <div>
                    <h1 class="tipografi mb-3">Discover <span class="text-primary">Recreation</span> and <span class="text-primary">Culinary</span> Experiences</h1>
                </div>
                ...
                <a class="btn btn-primary btn-lg" href="<?= base_url('pages/login'); ?>" role="button">Get's Started</a>
            </div>
